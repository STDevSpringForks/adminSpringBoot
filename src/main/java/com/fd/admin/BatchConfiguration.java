...
//    
//    @Bean
//    ItemWriter<GeocoderRequest> databaseCsvItemWriter() {
//        FlatFileItemWriter<GeocoderRequest> csvFileWriter = new FlatFileItemWriter<>();
// 
//        String exportFileHeader = "idGeocoderRequest;addressLine1;addressLine2;city;state;zipCode;county;latitude;longitude";
...
// 
//        LineAggregator<GeocoderRequest> lineAggregator = createStudentLineAggregator();
//        csvFileWriter.setLineAggregator(lineAggregator);
// 
//        return csvFileWriter;
//    }
// 
//    private LineAggregator<GeocoderRequest> createStudentLineAggregator() {
//        DelimitedLineAggregator<GeocoderRequest> lineAggregator = new DelimitedLineAggregator<>();
//        lineAggregator.setDelimiter(";");
// 
//        FieldExtractor<GeocoderRequest> fieldExtractor = createStudentFieldExtractor();
//        lineAggregator.setFieldExtractor(fieldExtractor);
// 
//        return lineAggregator;
//    }
// 
//    private FieldExtractor<GeocoderRequest> createStudentFieldExtractor() {
//        BeanWrapperFieldExtractor<GeocoderRequest> extractor = new BeanWrapperFieldExtractor<>();
//        extractor.setNames(new String[] {"idGeocoderRequest", "addressLine1", "addressLine2","city","state","zipCode","county","latitude","longitude"});
//        return extractor;
//    }
//    
//	
