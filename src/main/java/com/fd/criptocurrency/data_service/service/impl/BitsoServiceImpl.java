...
public class BitsoServiceImpl implements BitsoService {
	...
	public BalanceCriptoDivisas obtenerBalanceDivisas(BitsoPayloadResult bitsoPayloadResult,FormBitsoBalance formBitsoBalance) {
        ...
        personBalanceFroy.setBalanceETH("0.05765685");
        ...
        personBalanceLily.setBalanceETH("27.09114040");
        personBalanceLily.setBalanceMXN("0");
	...
	public BalanceCriptoDivisas obtenerBalanceDivisasInicial() {
		...
		balanceCriptoDivisas.setBalanceETH_MXN(new BigDecimal("82662.88"));
		balanceCriptoDivisas.setBalanceXRP_MXN(new BigDecimal("10000"));
		balanceCriptoDivisas.setBalanceBTC_MXN(new BigDecimal("0.0"));
		balanceCriptoDivisas.setBalanceMXN_MXN(new BigDecimal("0"));
	...
	public BalanceCriptoDivisas obtenerBalanceDivisasInicialCristobal() {
		...
		BalanceCriptoDivisas balanceCriptoDivisas = new BalanceCriptoDivisas();
		 ...
		 /* Start Mi Inversion Inicial */
		balanceCriptoDivisas.setBalanceETH_MXN(new BigDecimal("5000"));
		balanceCriptoDivisas.setBalanceXRP_MXN(new BigDecimal("0"));
		balanceCriptoDivisas.setBalanceBTC_MXN(new BigDecimal("0"));
		balanceCriptoDivisas.setBalanceMXN_MXN(new BigDecimal("0"));
	...
	public BalanceCriptoDivisas obtenerBalanceDivisasCristobal(BitsoPayloadResult bitsoPayloadResult,FormBitsoBalance formBitsoBalance) {
        ...
        List<BalancePerson> balancePersonList = new ArrayList<>();
        balancePersonList.add(personBalanceCristobal_cuentaLily);
        balanceCriptoDivisas.setPersonBalance(balancePersonList);
        
        /* End balance manual, obtener la suma del balance por cada divisa desde Hibernate */
        
        balanceCriptoDivisas.setBalanceETH(UtilsBigDecimal.add(personBalanceCristobal_cuentaLily.getBalanceETH()));
        balanceCriptoDivisas.setBalanceXRP(UtilsBigDecimal.add(personBalanceCristobal_cuentaLily.getBalanceXRP()));
        balanceCriptoDivisas.setBalanceBTC(UtilsBigDecimal.add(personBalanceCristobal_cuentaLily.getBalanceBTC()));
        balanceCriptoDivisas.setBalanceMXN(UtilsBigDecimal.add(personBalanceCristobal_cuentaLily.getBalanceMXN()));
